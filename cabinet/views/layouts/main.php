...
<?php $this->beginPage() ?>
        ...
        <div class="content">
            <header class="header">
                <div class="header__top">
                    <div class="container">
                        <div class="row">
                            <?php echo \cabinet\widgets\CurrentCity::widget() ?>
                ...
                <div class="header__bottom">
                    <div class="container">
                        <div class="row">
                            ...
                            <?php echo \cabinet\widgets\SearchFormWidget::widget() ?>
            ...
            <?php echo \cabinet\widgets\FilterWidget::widget(['dataGet' => Yii::$app->request->get()]); ?>
            <div class="filter">
                <div class="container">

                    <?php echo \cabinet\widgets\MegaMenuWidget::widget([
                        'city' => Yii::$app->requestedParams['city']
                    ]) ?>

                    <?php if (Yii::$app->controller->id == 'filter') echo \cabinet\widgets\LinkWidget::widget(['url' => Yii::$app->request->url]) ?>
    ...
    <div class="login">
        ...
        <div class="login-form-wrap">
            ...
            echo (new cabinet\widgets\LoginWidget)->run();
    ...
    <div class="register">
        ...
        <div class="login-form-wrap">
            ...
            echo (new cabinet\widgets\RegisterWidget)->run();
