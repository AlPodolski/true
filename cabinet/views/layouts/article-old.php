...
echo \cabinet\components\helpers\MicroHelper::image($post);
            ...
            <div
                ...
                <div class="carousel-inner">
                    <a class="active carousel-item" href="/post/<?php echo $post['id'] ?>">
                        <?php
                        $path = Yii::getAlias('@cabinet/views/includes/article-photo.php');
                    ...
                    <div class="rating-row-wrap">
                        <div class="article-rating d-flex">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                ...
                                <rect width="30" height="30" rx="10" fill="#0F2C93"/>
                            ...
                            <div class="photo-count white-bold-text">
                                +<?php echo \cabinet\modules\user\models\Posts::countPhoto($post['id']) ?> фото
                            </div>
                        </div>
                        ...
                        <div class="indi-marc post-marc ">
                            ...
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                ...
                                <path d="M13 18.0097V11.2003L18.2878 14.5078L13 18.0097Z" fill="white" stroke="white"
                                      stroke-width="2"/>
                                <mask class="path-3-inside-1" fill="white">
