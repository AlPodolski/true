...
use cabinet\modules\user\models\ReviewForm;
use cabinet\modules\user\models\ServiceReviewForm;
...
$countReview = \cabinet\modules\user\models\Posts::countReview($post['id']);
...
<article class="single position-relative" data-post-id="<?php echo $post['id'] ?>">
    <div class="row">
        <div class="col-12 col-lg-4 col-xl-4 position-relative">
                    ...
                    <div id="carouselExampleControls-<?php echo $post['id'] ?>" class="carousel slide"
                        ...
                        <div class="carousel-inner carousel-inner-post">
                            ...
                            <?php foreach ($post['gal'] as $item) : ?>
                                ...
                                <?php if ($item['type'] != \cabinet\models\Files::SELPHY_TYPE) : ?>
            ...
            <?php $postRating = \cabinet\helpers\PostRatingHelper::getPostRating($post['id']) ?>
            ...
            <div class="row height-100 single-post-info-row">
                <div class="col-12 col-md-12 col-lg-9 single-post-info-wrap">
                    <div class="post-top-info">
                        <div class="">
                            <h1 class="text-center"><?php echo $post['name'] ?> ID: <?php echo $post['id'] ?>,
                                Просмотров: <?php echo ViewCountHelper::countView($post['id'], Yii::$app->params['redis_post_single_view_count_key']) ?></h1>

                            <?php $targetPrice = \cabinet\components\helpers\PriceTargetHelper::target($post['price']) ?>
                        ...
                        <div class="photo-count phone-photo-count d-flex">
                            ...
                            <a href="#photo-count-<?php echo $post['id'] ?>" class="photo-count">
                                +<?php echo \cabinet\modules\user\models\Posts::countPhoto($post['id']) ?>
                                фото
                            </a>
                        </div>
                    ...
                    if (\cabinet\helpers\FavoriteHelper::isFavorite($post['id'])) $favoriteClass = 'favorite';
                ...
                <div class="row">
                    <div class="col-12 rating-item">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <?php $photoRating = \cabinet\helpers\PostRatingHelper::setPercentRating($postRating['photo_marc']) ?>
                                <div class="right">
                    ...
                    <div class="col-12 rating-item">
                        <div class="row">
                            ...
                            <?php $serviceRating = \cabinet\helpers\PostRatingHelper::setPercentRating($postRating['service_marc']) ?>
                            <div class="col-4">
                                <div class="right">
                    ...
                    <div class="col-12 rating-item">
                        <div class="row">
                            ...
                            <?php $totalRating = \cabinet\helpers\PostRatingHelper::setPercentRating($postRating['total_marc']) ?>
                            <div class="col-4">
                                <div class="right">
                    ...
                    <?php if ($serviceListReview) foreach ($serviceListReview as $service) : ?>
                        ...
                        <?php if (isset($service['review']) and $service['review']) : ?>
                            ...
                            <?php $serviceRating = \cabinet\helpers\PostRatingHelper::setPercentRating($service['review']) ?>
...
<div class="form-comment ">
    <?php echo $this->renderFile(Yii::getAlias('@app/views/post/comment-form.php'), compact('post')) ?>
</div>
