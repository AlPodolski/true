...
namespace cabinet\modules\chat\controllers;

use common\models\User;
use cabinet\components\helpers\SaveFileHelper;
use cabinet\models\Files;
use cabinet\modules\chat\models\Chat;
use cabinet\modules\chat\models\forms\SendMessageForm;
use cabinet\modules\chat\models\forms\SendPhotoForm;
    ...
    public function actionPhoto()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($file = UploadedFile::getInstance($model, 'file')) {
                ...
                if ($model->save()) echo $this->renderFile(Yii::getAlias('@cabinet/modules/chat/views/chat/image.php'), [
                    'img' => $photo->file,
                ]);
    ...
    public function actionDelete()
    {
        if (Yii::$app->request->isPost){
            ...
            if ($userDialog = UserDialog::find()->where(['dialog_id' => $id, 'user_id' => Yii::$app->user->id])
                ...
                \cabinet\modules\chat\models\Message::deleteAll(['chat_id' => $id]);
