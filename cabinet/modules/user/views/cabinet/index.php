...
<div class="container margin-top-20">
    ...
    <div class="row">
        ...
        <?php echo \cabinet\modules\user\widgets\SidebarWidget::widget(['user' => $user]) ?>
        ...
        <div class="col-12 col-md-12 col-lg-6 col-xl-7 <?php echo $viewType ?>">
            ...
            <div class="row">
                ...
                <div class="nav-posts post-publication-nav d-flex col-12">
                    ...
                    <div data-type="stop" class="start-all" onclick="get_photo_modal()">
                        Сменить фото на выделенных
                    </div>
                ...
                <div class="col-12 black-text font-weight-bold">
                    <?php if ($posts) {
                        ...
                        foreach ($posts as $post) {
                            ...
                            if ($post->status == \cabinet\modules\user\models\Posts::POST_ON_PUPLICATION_STATUS) {
...
<div class="modal fade" id="photoModal" tabindex="-1" role="dialog" aria-labelledby="photoModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-close-wrap">
                <svg data-dismiss="modal" aria-label="Close" width="34" height="34" viewBox="0 0 34 34"
                     fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <path
                            ...
                            fill="#0F2C93"/>
                    <path
                            d="M22.6797 20.6411L18.9509 16.9176L22.6797 13.1941C23.1933 12.6804 23.1933 11.8467 22.681 11.3316C22.166 10.8153 21.3323 10.8166 20.8173 11.3303L17.0859 15.0564L13.3545 11.3303C12.8395 10.8166 12.0058 10.8153 11.4908 11.3316C10.9771 11.8466 10.9771 12.6803 11.4921 13.1941L15.2209 16.9176L11.4921 20.6411C10.9771 21.1547 10.9771 21.9885 11.4908 22.5035C11.7477 22.7616 12.0861 22.8894 12.4233 22.8894C12.7606 22.8894 13.0977 22.7603 13.3546 22.5048L17.086 18.7786L20.8174 22.5048C21.0742 22.7616 21.4114 22.8894 21.7486 22.8894C22.0858 22.8894 22.4243 22.7603 22.6811 22.5035C23.1947 21.9885 23.1947 21.1547 22.6797 20.6411Z"
                            fill="#0F2C93"/>
                </svg>
            </div>
            <div class="modal-body phone-modal-body">
                ...
                <label for="avatar-all">
                    <span class="claim__modal">

                        <?php
                        $photoModel = new \cabinet\modules\user\models\forms\UpdateAllAvatarForm();
                        ...
                        <?= $form->field($photoModel, 'photo')
                            ->fileInput(['maxlength' => true,
                                'accept' => 'image/*', 'id' => 'avatar-all',
                                'onChange' => 'updateAvatars(this)',
                                'class' => 'd-none',
                            ])
                            ->label(false) ?>

                        <img src="/img/no-photo.png" alt="">
                        <p class="phone-heading update-photo">Нажмите что бы выбрать фото</p>
