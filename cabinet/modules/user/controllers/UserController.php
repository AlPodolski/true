...
use cabinet\models\ContactForm;
use cabinet\models\PasswordResetRequestForm;
use cabinet\models\ResendVerificationEmailForm;
use cabinet\models\ResetPasswordForm;
use cabinet\models\SignupForm;
use cabinet\models\VerifyEmailForm;
use Yii;
