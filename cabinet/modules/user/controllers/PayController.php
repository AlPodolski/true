...
use cabinet\modules\user\models\forms\ObmenkaPayForm;
use cabinet\modules\user\models\forms\PayForm;
    ...
    public function actionObmenkaPay($city)
    {
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            if ($tempData >= 10){
                ...
                if (!ObmenkaOrder::find()
                    ->andWhere(['status' => ObmenkaOrder::FINISH, 'user_id' => $model->user_id])
                    ->count()){
                    Yii::$app->user->logout();
                    return true;
                }
