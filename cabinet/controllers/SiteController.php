...
use cabinet\components\helpers\GetAdvertisingPost;
use cabinet\helpers\MetaBuilder;
use cabinet\helpers\FavoriteHelper;
use cabinet\helpers\shema\CatalogProductShema;
use cabinet\models\forms\PayForm;
use cabinet\models\Metro;
use cabinet\models\Webmaster;
use cabinet\components\AuthHandler;
...
use Yii;
use cabinet\modules\user\components\obmenka\Obmenka;
...
class SiteController extends Controller
{
    ...
    public function actions()
    {
        return [
            ...
            'auth' => [
                'class' => 'cabinet\components\AuthAction',
    ...
    public function actionPay()
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            $log_file = fopen(Yii::getAlias("@cabinet/web/files/pay_log5.txt"), 'a+');
            ...
            if ($payForm->validate()) {
                ...
                $log_file = fopen(Yii::getAlias("@cabinet/web/files/error_log.txt"), 'a+');
                fwrite($log_file, print_r($requestDAta = json_decode(file_get_contents('php://input')), true) . PHP_EOL);
    ...
    public function actionMap($city)
    {
        ...
        return $this->renderFile(Yii::getAlias('@cabinet/views/site/map.php'), [
            'metro' => $metro,
            'rayon' => $rayon,
            'service' => $service,
            'place' => $place,
