...
use cabinet\components\helpers\AddViewHelper;
use cabinet\helpers\GetCommentByPhoneHelper;
use cabinet\helpers\GetPostHelper;
use cabinet\helpers\RequestHelper;
use cabinet\helpers\shema\SingleProductShema;
use cabinet\models\Files;
use cabinet\models\forms\AnketClaimForm;
use cabinet\models\forms\GetCallForm;
use cabinet\models\forms\PhoneReviewForm;
use cabinet\modules\chat\models\relation\UserDialog;
use cabinet\modules\user\helpers\ServiceReviewHelper;
use cabinet\modules\user\helpers\ViewCountHelper;
use cabinet\modules\user\models\Posts;
use cabinet\modules\user\models\Profile;
use cabinet\repository\PostsRepository;
use Yii;
                    ...
                    if (!Yii::$app->user->isGuest) {
                        ...
                        if ($userToId) {
                            ...
                            if ($userTo['open_message'] == User::MESSAGE_ALLOWED) {
                                ...
                                return $this->renderFile(Yii::getAlias('@cabinet/modules/chat/views/chat/get-dialog.php'), [
                                    'dialog_id' => $dialog_id,
                                    'user' => $user,
                                    'userTo' => $userTo,
                                ...
                                return $this->renderFile(Yii::getAlias('@cabinet/views/layouts/message.php'),
                                    [
                        ...
                        return $this->renderFile(Yii::getAlias('@cabinet/views/layouts/authorisation.php'));
