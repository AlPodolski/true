...
return [
    ...
    'modules' => [
        'user' => [
            'class' => 'cabinet\modules\user\User',
        ],
        'advert' => [
            'class' => 'cabinet\modules\advert\advert',
        ],
        'chat' => [
            'class' => 'cabinet\modules\chat\Chat',
        ],
    ],
    'components' => [
        'request' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '<protocol>://<city:[a-z-0-9]+>.<domain>/' => 'user/cabinet/index',
                ...
                'POST <protocol>://<city:[a-z-0-9]+>.<domain>/cabinet/photo/delete' => 'user/photo/delete',
                ...
                '<protocol>://<city:[a-z-0-9]+>.<domain>/cabinet/up' => 'user/up/index',
