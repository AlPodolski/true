...
use backend\modules\chat\models\forms\SendMessageForm;
use backend\modules\chat\models\forms\SendPhotoForm;
use backend\modules\chat\models\Message;
...
class ChatController extends Controller
{
    ...
    public function actionGet($city)
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            return $this->renderFile(Yii::getAlias('@backend/modules/chat/views/chat/get-dialog.php'), [
                'dialog_id' => $dialog_id,
                'user' => $user,
                'userTo' => $userTo,
