...
<div class="page-block chat-block " data-to="<?php echo $userTo['id'] ?>">
    ...
    <div class="actions-wrap d-flex">
        ...
        <div class="number d-flex">
            ...
            <input class="phone-change" type="text" id="phone">

            <div onclick='editPhone(this)' data-id="<?php echo $userTo['id'] ?>" class="btn btn-success">Сохранить</div>
        ...
        <div class="chat-wrap" data-read="">
            ...
            <div class="chat ">
                ...
                <?php if (isset($dialog['message'])) : foreach ($dialog['message'] as $item) : ?>
                    ...
                    <div
                        class="wall-tem <?php if (Yii::$app->user->id == $item['author']['id']) echo 'right-message' ?>">
...
<div class="fast-message-block">
    ...
    <div onclick="setFastMessage(this)" class="fast-message-item" data-text="нужна выписка по карте в формате пдф с этим платежом">Выписка</div>
</div>
