...
use backend\models\MetaTemplate as MetaTemplateSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MetaTemplateController implements the CRUD actions for MetaTemplate model.
 */
class MetaTemplateController extends Controller
{
    ...
    {
        $searchModel = new MetaTemplateSearch();
