...
<div class="col-6 col-md-4 col-lg-6 col-sm-6 cabinet-item">
    ...
    <div class="white-cabinet-block cabinet-nav-block margin-top-20 d-flex items-center nav-cabinet-block">
        ...
        <div class="edit-block margin-top-20">
            ...
            <div class="delete-item edit-block-item" data-name="<?= $post['name'] ?>" onclick="delete_item(this)" data-id="<?= $post['id'] ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_576_92)">
                        <path d="M11.4826 6.52148C11.2497 6.52148 11.061 6.71019 11.061 6.94303V14.9102C11.061 15.1429 11.2497 15.3318 11.4826 15.3318C11.7154 15.3318 11.9041 15.1429 11.9041 14.9102V6.94303C11.9041 6.71019 11.7154 6.52148 11.4826 6.52148Z" fill="white"/>
                        <path d="M6.50846 6.52148C6.27562 6.52148 6.08691 6.71019 6.08691 6.94303V14.9102C6.08691 15.1429 6.27562 15.3318 6.50846 15.3318C6.7413 15.3318 6.93001 15.1429 6.93001 14.9102V6.94303C6.93001 6.71019 6.7413 6.52148 6.50846 6.52148Z" fill="white"/>
                        ...
                        <path d="M8.99576 6.52148C8.76293 6.52148 8.57422 6.71019 8.57422 6.94303V14.9102C8.57422 15.1429 8.76293 15.3318 8.99576 15.3318C9.2286 15.3318 9.41731 15.1429 9.41731 14.9102V6.94303C9.41731 6.71019 9.2286 6.52148 8.99576 6.52148Z" fill="white"/>
                    </g>
                    <defs>
