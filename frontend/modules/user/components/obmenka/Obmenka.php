...
class Obmenka
{
    ...
    private function createPay($orderId, $sum, $city, $currency, $des)
    {
        ...
        $data = [
            ...
            'currency' => $currency,
            "description" => $des,
            "success_url" => "https://".$city.".sex-true.com/pay/obmenka/".\str_replace('-'.Yii::$app->params['obm-id-pref'], '',$orderId),
            "fail_url" => "https://".$city.".sex-true.com/pay",
            "status_url" => "https://".$city.".sex-true.com/pay/obmenka/".\str_replace('-'.Yii::$app->params['obm-id-pref'], '',$orderId) ,
        ];
