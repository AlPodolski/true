                    ...
                    <div class="col-3 col-sm-4 col-xl-3 col-lg-4 col-md-4">
                        <div class="row">
                            ...
                            <?php if(\frontend\widgets\MetroWidget::checkExistMetro()) : ?>
                                ...
                                <div class=" col-md-8 metro-search-btn-wrap-top" data-type="metro" onclick="get_data(this)">
    ...
    <?php if(Yii::$app->controller->id == 'site'
        ...
        <div class="container">
            ...
            <div class="row metro-search-btn-wrap">
                ...
                <div class="col-6">
                    <div class="search-by-params-btn search-by-params-btn-bottom" data-type="filter" onclick="get_data(this)">
                        Поиск по параметрам
                        <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
                                <path d="M0.178459 0.70499L0.81969 0.010324L4.15384 3.62232L7.488 0.010324L8.12923 0.70499L4.79507 4.31699L4.15384 5.01166L0.178459 0.70499Z" fill="#F74952"/>
