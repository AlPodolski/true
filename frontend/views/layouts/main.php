        ...
        <div class="main-nav">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-3 col-sm-4 col-xl-3 col-lg-4 col-md-4">
                        <div class="row">
                            ...
                            <?php if (\frontend\widgets\MetroWidget::checkExistMetro()) : ?>
                                ...
                                <div class=" col-md-8 metro-search-btn-wrap-top" data-type="metro"
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 search-form-wrap">
                        <div class="search-wrap position-relative">
                            ...
                            <?= $form->field($searchName, 'name')
                                ->textInput(['class' => 'search', 'placeholder' => 'Поиск по имени'])->label(false) ?>
                    ...
                    <div class="col-xl-1 col-lg-1 col-md-2 col-1 user-btn-wrap">
                        <?php if (Yii::$app->user->isGuest) : ?>
                    ...
                    <div class="col-sm-2 col-1 col-md-2 col-lg-1">
...
<main>
    <?php if (Yii::$app->controller->id == 'site'
        ...
        <div class="container">
            ...
            <div class="search-by-params-btn search-by-params-btn-top" data-type="filter" onclick="get_data(this)">
                Поиск по параметрам
            ...
            <div class="row metro-search-btn-wrap">
                <div class="col-6">
                    <div class="metro-search-btn" data-type="metro" onclick="get_data(this)">
                ...
                <div class="col-6">
                    <div class="search-by-params-btn search-by-params-btn-bottom" data-type="filter"
                         onclick="get_data(this)">
                        Поиск по параметрам
                        <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <div class="city-wrap">
                    <ul class="city-list">
                        <li><a class="red-link" href="https://moskva.sex-true.com">Москва</a></li>
