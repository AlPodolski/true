                        ...
                        <div class="">
                            ...
                            <div class="likes-wrap d-flex">
                                <div class="like <?php if (LikeHelper::isLike($post['id'])) echo 'selected' ?>"
                                     onclick="like(this);ym(70919698,'reachGoal','like')" data-type="like"
...
<g>
    <path d="M498.323,297.032c0-7.992-1.901-15.683-5.553-22.635c12.034-9.18,19.23-23.438,19.23-38.914
		...
		C482.323,308.985,475.927,319.848,465.561,325.727z"></path>
...
<g>
    ...
    <path d="M80,264c-8.822,0-16,7.178-16,16s7.178,16,16,16s16-7.178,16-16S88.822,264,80,264z"></path>
                        ...
                        <div class="red-text " id="tell-me-text">НИКОГДА НЕ ПЕРЕВОДИТЕ ДЕНЬГИ ДО ВСТРЕЧИ <br> Скажите
                            что звоните с сайта <?php echo Yii::$app->request->serverName ?> я
                            и все пойму
                        </div>
