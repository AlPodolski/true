                    ...
                    <div class="col-12 col-md-9 col-lg-9 single-post-info-wrap">
                        <div class="post-top-info">
                            <div class="phone-photo-count">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <span data-id="<?php echo $post['id'] ?>" onclick="add_phone_view(this);ym(70919698,'reachGoal','call')"
                            ...
                            <div class="post-find-and-otzivi-count-block">
                                <div class="row">
                                    <div class="col-12 single-date-wrap">
                                        ...
                                        <span class="date"> <span class="find-date">Найдено</span> <?php echo date('m.d.y', $post['created_at'])?> </span>
                                    </div>
                                    <div class="col-12">
                        ...
                        <div class="btn-wrap">
                            ...
                            <?php if ($post['selphiCount']) :?>
                                ...
                                <div class="orange-btn selfi-btn"  onclick="get_modal(this)" data-target="selfy" data-id="<?php echo $post['id']?>">
                            ...
                            <?php if ($post['video']) : ?>
                                <div class="white-btn video-btn" onclick="get_modal(this)" data-target="video" data-id="<?php echo $post['id']?>">
                        ...
                        <div onclick="show_otzivi_block(this)" data-id="<?php echo $post['id'] ?>" class="white-block itzivi-block">
                        ...
                        <div onclick="show_anket_params_block(this)" class="white-block" data-id="<?php echo $post['id'] ?>">
...
<div class="tab-content">
    <div id="home<?php echo $post['id'] ?>" class="container tab-pane active"><br>
        <div class="row">
            <div class="col-4 bottom-gallery">
                ...
                <div data-img="<?php echo implode(',' , $imgs) ?>" id="bottom-imgs" class="img-grids"></div>
    ...
    <div id="menu2<?php echo $post['id'] ?>" class="container tab-pane fade bottom-gallery"><br>
